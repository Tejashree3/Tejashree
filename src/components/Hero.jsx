    ...
    <div className="mt-24 p-4 max-w-[1200px] mx-auto relative">
        <div className="grid md:grid-cols-2 place-items-center gap-8">
            ...
            >
                ...
                >
                    HEY, I AM <br/>
                    <span className="text-primary">TEJASHREE DHALGADE</span>
                </motion.p>
                ...
                >
                    I am a passionate frontend developer with over 1 years of experience.
                </motion.p>
...
<a 
  ...
  >
        ...
        >
            ...
            <SiTailwindcss className="text-[#38bdf8] mx-2 " />
