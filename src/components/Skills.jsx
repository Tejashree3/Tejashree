...
const skills = [
    {
      ...
      technologies: [
        ...
        {name: 'Tailwind', icon :<BiLogoTailwindCss className='text-cyan-500' />},
  ...
  return (
    <div className="max-w-[1200px] mx-auto flex flex-col items-center justify-center px-4 text-gray-200 pb-8 md:py-12" id="skills">
        ...
        <p className="text-center mb-8">
            I worked on various frontend and React projects. Check them <a href="#" className="underline">there</a>.
        </p>

        <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8
                        ">
            {skills.map((skill, index) => (
                <div key={index} className="border border-primary p-6 rounded-lg bg-purple-900/20 shadow-lg 
                                w-full md:w-1/2">
